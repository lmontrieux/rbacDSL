 ...
 * <ul>
 *   <li>{@link uk.ac.open.rbacDSL.impl.UserRoleScenarioImpl#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public class UserRoleScenarioImpl extends MinimalEObjectImpl.Container implements UserRoleScenario
{
  /**
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RbacDSLPackage.USER_ROLE_SCENARIO__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RbacDSLPackage.USER_ROLE_SCENARIO__NAME:
        return getName();
